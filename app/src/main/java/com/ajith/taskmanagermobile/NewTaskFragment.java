...
public class NewTaskFragment extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        newTastText = getView().findViewById(R.id.newTaskText);
        ...
        newTastText.addTextChangedListener(new TextWatcher() {
            @Override
        ...
        newTaskSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String text = newTastText.getText().toString();
                if(finalIsUpdate){
